...
headerCells[1].addEventListener("click", ()=>{
    ...
    const sortedRows = rows.sort((rowA, rowB)=>{
        ...
        return isAscending ? positionA.localeCompare(positionB) : positionB.localeCompare(positionA);
    });
    tbody.innerHTML = "";
    sortedRows.forEach((row)=>tbody.appendChild(row));
    isAscending = !isAscending;
...
headerCells[2].addEventListener("click", ()=>{
    ...
    const sortedRows = rows.sort((rowA, rowB)=>{
        ...
        return isAscending ? officeA.localeCompare(officeB) : officeB.localeCompare(officeA);
    });
    tbody.innerHTML = "";
    sortedRows.forEach((row)=>tbody.appendChild(row));
    isAscending = !isAscending;
...
headerCells[4].addEventListener("click", ()=>{
    ...
    const sortedRows = rows.sort((rowA, rowB)=>{
        const salaryA = parseInt(rowA.querySelector("td:nth-child(5)").textContent.trim().replace(/[$,]/g, ""), 10);
        const salaryB = parseInt(rowB.querySelector("td:nth-child(5)").textContent.trim().replace(/[$,]/g, ""), 10);
...
form.addEventListener("submit", function(e) {
    ...
    if (!formName || !formOffice || !formPosition || isNaN(formAge) || isNaN(formSalary) || formSalary === "") {
